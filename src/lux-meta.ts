...
export const luxMeta: Record<string, Record<string, MetaInfo | undefined>> = {
    values: {
        ...
        // added in luxtronik2 >= 2.7 (newer firmware)
        ...
        temperature_overheating: { role: 'value', type: 'number', unit: 'K' },
        temperature_overheating_target: { role: 'value', type: 'number', unit: 'K' },
        HDin_pressure: { role: 'value.pressure', type: 'number', unit: 'bar' },
        NDin_pressure: { role: 'value.pressure', type: 'number', unit: 'bar' },
        errors: undefined,
    ...
    parameters: {
        ...
        // added in luxtronik2 >= 2.7 (newer firmware)
        heatingTemperatureOutside2ndCompressor: {
            role: 'value.temperature',
            type: 'number',
            unit: '°C',
            writeName: 'heating_temperature_outside_2nd_compressor',
            min: -20,
            max: 30,
        },
        hotwaterTemperatureForerun2ndCompressor: {
            role: 'value.temperature',
            type: 'number',
            unit: '°C',
            writeName: 'hotwater_temperature_forerun_2nd_compressor',
            min: 10,
            max: 70,
        },
        solarPumpDeaerate: { role: 'switch', type: 'boolean', writeName: 'solarPumpDeaerate' },
        runDeaerate: { role: 'switch', type: 'boolean', writeName: 'runDeaerate' },
